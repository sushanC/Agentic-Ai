...
export const modelRegistry = {
  ...
  gemini: {
    ...
    capabilities: ["general_chat", "memory", "vision", "assistant", "conversation", "memory_extraction"],
    ...
    fallback: "groq",
    fallbackChain: ["groq", "gpt-oss", "ollama"],
    latency: "fast",
    latencyTier: "fast",
  ...
  deepseek: {
    ...
    priority: 1,
    status: "disabled", // Future reactivation: process.env.DEEPSEEK_API_KEY ? "online" : "offline"
    reserved: false,
    supportsStreaming: true,
  ...
  "gpt-oss": {
    ...
    capabilities: ["research", "writing", "planning", "pdf", "web_search", "agent_planning", "general_chat"],
    ...
    supportsOffline: false,
    fallback: "gemini",
    fallbackChain: ["gemini", "groq", "ollama"],
    latency: "medium",
    latencyTier: "medium",
  ...
  nemotron: {
    ...
    enabled: false, // Future reactivation: !!process.env.OPENROUTER_API_KEY
    priority: 1,
    status: "disabled", // Future reactivation: process.env.OPENROUTER_API_KEY ? "online" : "offline"
    reserved: false,
    supportsStreaming: true,
    supportsVision: false,
    supportsReasoning: true,
  ...
  groq: {
    ...
    capabilities: ["coding", "reasoning", "mathematics", "tool_calling", "general_chat"],
    ...
    supportsOffline: false,
    fallback: "gemini",
    fallbackChain: ["gemini", "gpt-oss", "ollama"],
    latency: "very_fast",
  ...
  ollama: {
    ...
    capabilities: ["offline", "general_chat", "coding", "research"],
