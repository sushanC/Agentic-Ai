...
{}`;
  ...
  if (
  normalizedIntent === "actionplanning" ||
  (
    normalizedIntent === "planning" &&
    userPrompt.includes("actions")
  )
) {
...
desktop_volume
Get or change system volume.

desktop_system_info
Return OS, CPU, RAM, disk, hostname, architecture.

desktop_search_files
Search for files by name, extension or location.
...
User:
Create a folder called AI Research
...
User:
Create a folder called Reports and open it
